...
def build_simulation_model(train_Xs, test_Xs, train_Ys, test_Ys, n_init=200000, tune=500):
    """
    ...
    """
    mcmc_betas = get_mcmc_betas(train_Ys, train_Xs, n_init=n_init, tune=tune)
